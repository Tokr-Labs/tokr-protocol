...
const accounts_1 = require("../../../programs/governance/js/src/governance/accounts");
const withDepositGoverningTokens_1 = require("../../../programs/governance/js/src/governance/withDepositGoverningTokens");
const withCreateMintGovernance_1 = require("../../../programs/governance/js/src/governance/withCreateMintGovernance");
const withSetRealmAuthority_1 = require("../../../programs/governance/js/src/governance/withSetRealmAuthority");
const withCreateGovernance_1 = require("../../../programs/governance/js/src/governance/withCreateGovernance");
const withCreateRealm_1 = require("../../../programs/governance/js/src/governance/withCreateRealm");
