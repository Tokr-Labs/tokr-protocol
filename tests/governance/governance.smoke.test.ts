...
describe.skip("governance smoke test", () => {
    ...
    test.skip('getAllGovernances', async () => {
        // Arrange
    ...
    test.skip('getAllProposals', async () => {
        // Arrange
    ...
    test.skip('getAllTokenOwnerRecords', async () => {
        // Arrange
        const realmPk = new PublicKey("EDJ6Uc1U51x1SemSygLEjkvtzNMUWMm1wMf4tANQz9Qu")
    ...
    test.skip('tryGetRealmConfig', async () => {
        // Arrange
    ...
    test.skip('setGovernanceDelegate', async () => {
        // Arrange
        const wallet = Keypair.generate();
        const walletPk = wallet.publicKey;
